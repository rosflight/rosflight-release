...
typedef enum OFFBOARD_CONTROL_MODE
{
	...
	OFFBOARD_CONTROL_MODE_ENUM_END=4, /*  | */
...
/** @brief  */
#ifndef HAVE_ENUM_ROSFLIGHT_FC_STATUS
#define HAVE_ENUM_ROSFLIGHT_FC_STATUS
typedef enum ROSFLIGHT_FC_STATUS
{
	ROSFLIGHT_STATUS_ARMED=1, /*  | */
	ROSFLIGHT_STATUS_IN_FAILSAFE=2, /*  | */
	ROSFLIGHT_STATUS_RC_OVERRIDE=4, /*  | */
	ROSFLIGHT_STATUS_OFFBOARD_CONTROL_ACTIVE=8, /*  | */
	ROSFLIGHT_FC_STATUS_ENUM_END=9, /*  | */
} ROSFLIGHT_FC_STATUS;
#endif
...
typedef enum ROSFLIGHT_ERROR_CODE
{
	...
	ROSFLIGHT_ERROR_CODE_ENUM_END=9, /*  | */
...
#include "./mavlink_msg_small_sonar.h"
